...
Wellness tip: Schedule a 'Power 90' after your Win Before 10 morning ritual — 90 uninterrupted minutes during your peak energy time. Protect this like your most important meeting.

IMPORTANT BUT CAN BE SCHEDULED:
• [3-4 items]

Wellness tip: Time block these when your energy naturally flows. Use 20-minute focused sessions — your brain needs breaks to stay sharp.

HANDLE QUICKLY, DEFER, OR DELEGATE:
• [Items]

Wellness tip: Apply the two-minute rule for quick tasks. For the rest, ask 'Who else could do this?' Remember: if delegation isn't possible, deferring to a specific time is better than letting it float in your head.

CONSIDER ELIMINATING:
• [Low-value items]

Wellness tip: Ask 'Is this energizing or draining me?' If it's draining without clear benefit, let it go. Your energy is precious."
